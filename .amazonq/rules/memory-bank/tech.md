...
- App ID: `com.richardlesh.asdq-chart`
- Artifact naming: `ASDQChart-{version}-{arch}.{ext}`
...
## Persisted Data
- Settings file: `~/.asdq-chart-settings.json` (written by main process via `fs` module)
